...
if(opts.tools){//龙鸿文.......................................tools新增text属性（本身只有iconCls和handler两个属性而已）。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。
if($.isArray(opts.tools)){
for(var i=0;i<opts.tools.length;i++){
	if(opts.tools[i].text != undefined){
		var t=$("<a id=\""+opts.tools[i].iconCls+"\" href=\"javascript:void(0)\" style=\"width:auto;padding:6px 6px 4px 6px;\"><p class=\""+opts.tools[i].iconCls+"\" style=\"width:16px;height:16px;float:left;\"></p>"+opts.tools[i].text+"</a>").appendTo(tool);
//		var t=$("<a href=\"javascript:void(0)\" title=\""+opts.tools[i].text+"\"></a>").addClass(opts.tools[i].iconCls).appendTo(tool);
	}else{
//		var t=$("<a href=\"javascript:void(0)\" ></a>").addClass(opts.tools[i].iconCls).appendTo(tool);
		var t=$("<a id=\""+opts.tools[i].iconCls+"\" href=\"javascript:void(0)\" style=\"width:auto;padding:6px 6px 4px 6px;\"><p class=\""+opts.tools[i].iconCls+"\" style=\"width:16px;height:16px;float:left;\"></p></a>").appendTo(tool);
...
var _29d="<div style=\"width:100%;height:32px;line-height:32px;\">"+msg+"</div>";
switch(icon){
case "error":
...
if(opts.pagination){
$.extend(_6c5,{page:opts.pageNumber||1,pageSize:opts.pageSize});
}
if(opts.sortName){
...
if(opts.pagination){
$.extend(_836,{page:opts.pageNumber,pageSize:opts.pageSize});
}
if(opts.sortName){
        ...
        query:function(q){  
            ...
            for(var i=0; i<nodes.length; i++){  
                ...
                if (node.text.indexOf(q) >= 0){  
                    $(node.target).parent('li').show();  
                } else {  
                	$(node.target).parent('li').hide();  
                }  
            }  
            var opts = $(this).combotree('options');  
